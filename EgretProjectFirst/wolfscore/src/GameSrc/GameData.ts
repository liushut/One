//全局类
class GameData {
    public static FPS:number = 10;//FPS 
    public static BUFFER_TIME:number = 100;//网络延迟
    ...
    public static p1:string = "r";//红玩家
    public static p2:string = "b";//蓝玩家

    private static player1:Player = new Player(GameData.p1);
    private static player2:Player = new Player(GameData.p2);

    public static type:string = GameData.p1;//r boolean  当前玩家
    ...
    public static getOtherPlayer()
    {
     ...
     public static initPlayer(type: string, name:string, ID:number, url:string) {
