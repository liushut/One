class ChushouSDK {
	...
	* "hostOpenUid" : "sl10702"
	...
	public csGetUserRelationship(targetUid, cb?: (data: any) => void): void {
		console.log("csGetUserRelationship")
		csGetUserRelationship(`{"accessToken" : "${this.csAuthRequestData.accessToken}","users" : "{${targetUid}}"}`, (data: string) => {
	...
	public csPayEntryFee(cb?: (data: any) => void): void {
		console.log("csPayEntryFee")
		csPayEntryFee(`{"accessToken" : "${this.csAuthRequestData.accessToken}","cpOrderId" : "prop7865425","cpPropName" : "游戏⼊场费","cpPropId" : "999"}`, (data: string) => {
