...
var ChushouSDK = (function () {
    ...
    ChushouSDK.prototype.csGetUserRelationship = function (targetUid, cb) {
        ...
        csGetUserRelationship("{\"accessToken\" : \"" + this.csAuthRequestData.accessToken + "\",\"users\" : \"{" + targetUid + "}\"}", function (data) {
    ...
    ChushouSDK.prototype.csPayEntryFee = function (cb) {
        console.log("csPayEntryFee");
        csPayEntryFee("{\"accessToken\" : \"" + this.csAuthRequestData.accessToken + "\",\"cpOrderId\" : \"prop7865425\",\"cpPropName\" : \"\u6E38\u620F\u2F0A\u573A\u8D39\",\"cpPropId\" : \"999\"}", function (data) {
