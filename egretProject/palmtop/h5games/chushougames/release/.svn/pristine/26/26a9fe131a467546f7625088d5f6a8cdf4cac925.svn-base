window.skins={};
	...
	function GameViewSkin() {
		_super.call(this);
		this.skinParts = ["bg1","bg2","topFather","nickNameID","nickName","healthLabel","scoreBitLabel","bgAll","danjuchi","backFather","game"];
		
		this.height = 1920;
		this.width = 1080;
		this.elementsContent = [this.bg1_i(),this.bg2_i(),this.topFather_i(),this.game_i()];
	}
	...
	_proto.game_i = function () {
		...
		t.horizontalCenter = 0;
		t.width = 1080;
		t.elementsContent = [this.bgAll_i(),this.backFather_i()];
		return t;
	};
	_proto.bgAll_i = function () {
		...
		t.x = 0;
		t.y = 90;
		t.elementsContent = [this.nickNameID_i(),this.nickName_i(),this.healthLabel_i(),this.scoreBitLabel_i()];
		return t;
	};
	...
	_proto.backFather_i = function () {
		...
		t.x = 0;
		t.y = 1820;
		t.elementsContent = [this.danjuchi_i()];
		return t;
	};
	_proto.danjuchi_i = function () {
		var t = new eui.Image();
		this.danjuchi = t;
		t.anchorOffsetX = 0;
		t.anchorOffsetY = 0;
		t.height = 200;
		t.rotation = 0;
		t.scale9Grid = new egret.Rectangle(22,108,136,10);
		t.scaleX = 1;
		t.scaleY = 1;
