...
get_value(Key, List, int) ->
    to_integer(proplists:get_value(Key, List, 0));
get_value(Key, List, string) ->
    to_list(proplists:get_value(Key, List, ""));
get_value(Key, List, bool) ->
    to_bool(proplists:get_value(Key, List, 0));
get_value(Key, List, _) ->
