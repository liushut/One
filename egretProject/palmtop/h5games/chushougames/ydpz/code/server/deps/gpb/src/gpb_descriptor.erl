...
-export_type(['UninterpretedOption.NamePart'/0, 'UninterpretedOption'/0, 'EnumValueOptions'/0, 'EnumValueDescriptorProto'/0, 'ServiceOptions'/0, 'MethodOptions'/0, 'MethodDescriptorProto'/0, 'ServiceDescriptorProto'/0, 'FieldOptions'/0, 'DescriptorProto.ExtensionRange'/0, 'DescriptorProto.ReservedRange'/0, 'MessageOptions'/0, 'OneofDescriptorProto'/0, 'EnumOptions'/0, 'EnumDescriptorProto'/0, 'FieldDescriptorProto'/0, 'DescriptorProto'/0, 'GeneratedCodeInfo.Annotation'/0, 'GeneratedCodeInfo'/0, 'SourceCodeInfo.Location'/0, 'SourceCodeInfo'/0, 'FileOptions'/0, 'FileDescriptorProto'/0, 'FileDescriptorSet'/0]).

-spec encode_msg(#'UninterpretedOption.NamePart'{} | #'UninterpretedOption'{} | #'EnumValueOptions'{} | #'EnumValueDescriptorProto'{} | #'ServiceOptions'{} | #'MethodOptions'{} | #'MethodDescriptorProto'{} | #'ServiceDescriptorProto'{} | #'FieldOptions'{} | #'DescriptorProto.ExtensionRange'{} | #'DescriptorProto.ReservedRange'{} | #'MessageOptions'{} | #'OneofDescriptorProto'{} | #'EnumOptions'{} | #'EnumDescriptorProto'{} | #'FieldDescriptorProto'{} | #'DescriptorProto'{} | #'GeneratedCodeInfo.Annotation'{} | #'GeneratedCodeInfo'{} | #'SourceCodeInfo.Location'{} | #'SourceCodeInfo'{} | #'FileOptions'{} | #'FileDescriptorProto'{} | #'FileDescriptorSet'{}) -> binary().
...
get_msg_names() ->
    ['UninterpretedOption.NamePart', 'UninterpretedOption',
     ...
     'FieldOptions', 'DescriptorProto.ExtensionRange',
     'DescriptorProto.ReservedRange', 'MessageOptions',
     'OneofDescriptorProto', 'EnumOptions',
     'EnumDescriptorProto', 'FieldDescriptorProto',
     'DescriptorProto', 'GeneratedCodeInfo.Annotation',
     'GeneratedCodeInfo', 'SourceCodeInfo.Location',
     'SourceCodeInfo', 'FileOptions', 'FileDescriptorProto',
     'FileDescriptorSet'].
