window.skins={};
	...
	function GameViewSkin() {
		_super.call(this);
		this.skinParts = ["juzhong","quanping","bg1","bg2","topFather","backFather","scoreBitLabel","perfectImg","pts","start","add","five","startGroup","perfectImg0","pts0","hit","add0","three","hitGroup","perfectImg1","pts1","hit0","cheng","add1","four","comboNum","comboGroups","perfectGroup","bgAll","game"];
		
		this.height = 1920;
		this.width = 1080;
		this.elementsContent = [this.juzhong_i(),this.quanping_i(),this.bg1_i(),this.bg2_i(),this.game_i()];
	}
	...
	_proto.bgAll_i = function () {
		...
		t.x = 0;
		t.y = 0;
		t.elementsContent = [this.topFather_i(),this.backFather_i(),this.scoreBitLabel_i(),this.perfectGroup_i(),this._Image1_i(),this._Image2_i()];
		return t;
	};
	...
	_proto._Image1_i = function () {
		...
		t.anchorOffsetY = 0;
		t.height = 306;
		t.scale9Grid = new egret.Rectangle(2,72,130,58);
