window.skins={};
	...
	function GameViewSkin() {
		_super.call(this);
		this.skinParts = ["bg1","bg2","topFather","shangjuchi","nickNameID","nickName","healthLabel","xiajuchi","scoreBitLabel","bgAll","game"];
		
		this.height = 1920;
		this.width = 1080;
		this.elementsContent = [this.bg1_i(),this.bg2_i(),this.topFather_i(),this.shangjuchi_i(),this.game_i()];
	}
	...
	_proto.bgAll_i = function () {
		...
		t.width = 1080;
		t.x = 0;
		t.y = 90.00000000000001;
		t.elementsContent = [this.nickNameID_i(),this.nickName_i(),this.healthLabel_i(),this.xiajuchi_i(),this.scoreBitLabel_i(),this._Image1_i()];
		return t;
	};
	...
	_proto._Image1_i = function () {
		...
		t.anchorOffsetY = 0;
		t.height = 216.97;
		t.scale9Grid = new egret.Rectangle(0,111,179,12);
		t.scaleY = -1;
