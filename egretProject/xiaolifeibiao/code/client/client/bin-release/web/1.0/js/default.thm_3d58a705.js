...
generateEUI.paths['resource/eui_skins/ButtonSkin.exml'] = window.skins.ButtonSkin = (function (_super) {
	...
	function GameViewSkin() {
		_super.call(this);
		this.skinParts = ["bgdb","guidao","tarImg","guidao1","guidao2","guidao3","guidao4","yuanImg","bgDi","bardi","bar","life1","life2","life3","life","jifen","add","defen","addFen","dituo","bg","arrow","arrImg","arrHuiImg","bgAll"];
	...
	_proto.bgAll_i = function () {
		...
		t.verticalCenter = 0;
		t.width = 965;
		t.elementsContent = [this.bgdb_i(),this.guidao_i(),this.tarImg_i(),this.guidao1_i(),this.guidao2_i(),this.guidao3_i(),this.guidao4_i(),this.yuanImg_i(),this.bgDi_i(),this.bardi_i(),this.bar_i(),this.life_i(),this.jifen_i(),this.addFen_i(),this.dituo_i(),this.bg_i(),this.arrImg_i(),this.arrHuiImg_i()];
		return t;
	};
	...
	_proto.addFen_i = function () {
		var t = new eui.Group();
		this.addFen = t;
		t.visible = false;
		t.width = 200;
		t.elementsContent = [this.add_i(),this.defen_i()];
		return t;
	};
