...
generateEUI.paths['resource/eui_skins/ButtonSkin.exml'] = window.skins.ButtonSkin = (function (_super) {
...
})(eui.Skin);generateEUI.paths['resource/eui_skins/view/SettleSingleView.exml'] = window.SettleSingleViewSkin = (function (_super) {
	__extends(SettleSingleViewSkin, _super);
	var SettleSingleViewSkin$Skin1 = 	(function (_super) {
		__extends(SettleSingleViewSkin$Skin1, _super);
		function SettleSingleViewSkin$Skin1() {
			_super.call(this);
			this.skinParts = ["labelDisplay"];
		...
		var _proto = SettleSingleViewSkin$Skin1.prototype;
		...
		return SettleSingleViewSkin$Skin1;
	})(eui.Skin);

	var SettleSingleViewSkin$Skin2 = 	(function (_super) {
		__extends(SettleSingleViewSkin$Skin2, _super);
		function SettleSingleViewSkin$Skin2() {
			_super.call(this);
			this.skinParts = ["labelDisplay"];
		...
		var _proto = SettleSingleViewSkin$Skin2.prototype;
		...
		return SettleSingleViewSkin$Skin2;
	})(eui.Skin);

	function SettleSingleViewSkin() {
		_super.call(this);
		this.skinParts = ["gBg","bg","icon","icon0","icon1","icon2","icon3","phb","score","restart","big"];
		
		this.height = 1920;
		this.width = 1080;
		this.elementsContent = [this.gBg_i(),this._Group1_i(),this.big_i()];
	}
	var _proto = SettleSingleViewSkin.prototype;
	...
	_proto._Group1_i = function () {
		...
		t.top = 0;
		t.touchEnabled = false;
		t.elementsContent = [this.bg_i(),this.icon_i(),this.icon0_i(),this.icon1_i(),this.icon2_i(),this.icon3_i(),this.phb_i(),this.score_i(),this.restart_i()];
		return t;
	};
	_proto.bg_i = function () {
		var t = new eui.Image();
	...
	_proto.phb_i = function () {
		...
		t.skinName = SettleSingleViewSkin$Skin1;
		return t;
	};
	...
	_proto.restart_i = function () {
		...
		t.skinName = SettleSingleViewSkin$Skin2;
		return t;
	};
	...
	var SettleViewSkin$Skin3 = 	(function (_super) {
		__extends(SettleViewSkin$Skin3, _super);
		function SettleViewSkin$Skin3() {
			_super.call(this);
			this.skinParts = ["labelDisplay"];
			...
			this.states = [
				...
				new eui.State ("down",
					[
						new eui.SetProperty("_Image2","source","dengdai_png")
					])
				,
				new eui.State ("disabled",
					[
		...
		var _proto = SettleViewSkin$Skin3.prototype;
		...
		return SettleViewSkin$Skin3;
	})(eui.Skin);

	function SettleViewSkin() {
		_super.call(this);
		this.skinParts = ["gBg","bg","icon","restart","big"];
	...
	_proto._Group1_i = function () {
		...
		t.touchEnabled = false;
		t.width = 1080;
		t.elementsContent = [this.bg_i(),this.icon_i(),this._Image1_i(),this._Image2_i(),this._Image3_i(),this._Image4_i(),this._Image5_i(),this._Image6_i(),this._Image7_i(),this.restart_i()];
		return t;
	};
	_proto.bg_i = function () {
		var t = new eui.Image();
	...
	_proto._Image1_i = function () {
		...
		t.scaleX = 0.8;
		t.scaleY = 0.8;
		t.source = "touxiangdi_png";
		t.verticalCenter = -202.66666666666674;
		t.width = 122;
		return t;
	};
	_proto._Image2_i = function () {
		...
		t.scaleX = 0.8;
		t.scaleY = 0.8;
		t.source = "touxiangkuang_png";
		t.verticalCenter = -206.16666666666674;
		t.width = 148;
		return t;
	};
	...
	_proto._Image5_i = function () {
		...
		t.scaleX = 0.8;
		t.scaleY = 0.8;
		t.source = "fenshudi2_png";
		t.verticalCenter = -31.166666666666742;
		t.width = 309;
		return t;
	};
	_proto._Image6_i = function () {
		var t = new eui.Image();
		t.horizontalCenter = -154.5;
		t.scaleX = 0.8;
		t.scaleY = 0.8;
		t.source = "fenshudi_png";
		t.verticalCenter = -30.666666666666742;
		return t;
	};
	_proto._Image7_i = function () {
		...
		t.scaleX = 0.8;
		t.scaleY = 0.8;
		t.source = "guanzhuta_png";
		t.verticalCenter = 62.33333333333326;
		return t;
	};
	_proto.restart_i = function () {
		var t = new eui.Button();
		...
		t.scaleY = 1;
		t.top = 1041;
		t.verticalCenter = 417.83333333333326;
		t.skinName = SettleViewSkin$Skin3;
		return t;
	};
	_proto.big_i = function () {
		var t = new eui.Button();
